...
class EndoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask = tiff.imread('ead2020_semantic_segmentation/masks_ead2020/EAD2020_semantic_'+"{:05d}".format(idx)+'.tif')
        img = cv2.imread('ead2020_semantic_segmentation/images_ead2020/EAD2020_semantic_'+"{:05d}".format(idx)+'.jpg')
